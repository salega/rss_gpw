...
def prepare_request(has_reports: bool):
    ...
    " podsumowanie rachunku zysków i strat, EBITDA, przychody, koszty (i pokaż jak zmieniały się przychody, EBITDA i koszty w czasie), cena/wartość księgowa, zadłużenie"
